 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_HYSTERESIS     7 // (°C)
 ...
 */
  ...
  #define PID_FAN_SCALING
    ...
    #define PID_FAN_SCALING_ALTERNATIVE_DEFINITION
      ...
      #define PID_FAN_SCALING_LIN_FACTOR (int)(PID_FAN_SCALING_AT_FULL_SPEED-DEFAULT_Kf)

    #else
      #define PID_FAN_SCALING_LIN_FACTOR (0)             // Power-loss due to cooling = Kf * (fan_speed)
      #define DEFAULT_Kf 110                              // A constant value added to the PID-tuner
      #define PID_FAN_SCALING_MIN_SPEED 10               // Minimum fan speed at which to enable PID_FAN_SCALING
    #endif
  #endif
#endif
...
#define FAN_KICKSTART_POWER 70  // 64-255
...
//#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  10, 10 }, { (X_BED_SIZE)-10,  10 }, { (X_BED_SIZE)-10, (Y_BED_SIZE)-10 }, { 10, (Y_BED_SIZE)-10 } }
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 30*60, 30*60, 5*60, 6*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define BABYSTEPPING
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // Double-click on the Status Screen for Z Babystepping.
    ...
    #define MOVE_Z_WHEN_IDLE              // Jump to the move Z menu on double-click when printer is idle.
      ...
      #define MOVE_Z_IDLE_MULTIPLICATOR 0.5   // Multiply 1mm by this factor for the move step size.
    #endif
  #endif
 ...
 * Override the default value based on the driver type set in Configuration.h.
 */
//#define MAXIMUM_STEPPER_RATE 350000
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    //#define X_HOLD_MULTIPLIER 1    // Enable to override 'HOLD_MULTIPLIER' for the X axis
  #endif
