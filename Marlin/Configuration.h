...
#define STRING_CONFIG_H_AUTHOR "(Blindfold, Anet config)" // Who made the changes.
...
#define DEFAULT_bedKp 124.93
#define DEFAULT_bedKi 23.64
#define DEFAULT_bedKd 440.23
  //120V 250W silicone heater into 4mm borosilicate (MendelMax 1.5+)
  //from pidautotune
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 1600, 1600, 600, 97 }
...
#define Z_SERVO_ANGLES { 27, 44 } // Z Servo Deploy and Stow angles
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 64, 20, -5.143 }
